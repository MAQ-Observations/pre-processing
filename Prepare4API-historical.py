...
#else:
day1        = np.datetime64('2022-01-21').astype('datetime64[D]')
day2        = np.datetime64('2024-06-12').astype('datetime64[D]') + np.timedelta64(2,'D') # inclusive


#--- Select which streams to process
all_streams = ['Veenkampen_Meteo','Veenkampen_Flux','Veenkampen_BC','Veenkampen_PM','Veenkampen_Teledyne','Loobos_BM','Loobos_BM-Backup','Loobos_BM_Soil','Loobos_BM_Precip','Loobos_EC','Loobos_ST','Loobos_LFW','Amsterdam_Rad','Amsterdam_Flux'] #'Loobos_AQ',
do_streams  = all_streams
do_streams  = ['Loobos_BM']
