...
t1          = np.datetime64('2022-01-21').astype('datetime64[D]')
t2          = np.datetime64('2024-06-13').astype('datetime64[D]') # exclusive

#--- Select which streams to process
all_streams = ['VK_Meteo','VK_Flux','VK_BC','VK_PM','VK_Teledyne','LB_BM','LB_BM_Backup','LB_BM_Precipitation','LB_BM_soil','LB_EC','LB_ST','LB_LFW','AD_Rad','AD_Flux'] #'LB_AQ'
