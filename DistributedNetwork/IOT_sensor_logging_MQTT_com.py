...
Currently supported:
    ...
    SDI-12logger for Atmos22 anemometers (name starts with u)
...
data_path = "C:\\AAMS_data\\DistributedNetwork\\"

APP_ID = 'aams-network'
DEVICE_ID = 'A8404180D65C1F8D'
...
def on_message(client, userdata, message):
    ...
    if not(b64_payload==None):  #sometimes the sensor data payload is empty
        ...
        CSV_FILE = data_path+"IOT_data_"+today_str+".csv"
        CSV_FILE_yesterday = data_path+"IOT_data_"+yesterday_str+".csv"
