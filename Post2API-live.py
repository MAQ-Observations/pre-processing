...
all_streams = ['VK_Meteo','VK_Flux','VK_BC','VK_PM','VK_Teledyne','LB_BM','LB_BM_Backup','LB_BM_Precipitation','LB_BM_soil','LB_EC','LB_ST','LB_AQ','LB_LFW','AD_Rad','AD_Flux']
do_streams  = all_streams
do_streams  = ['VK_Meteo','VK_Flux','VK_BC','VK_PM','VK_Teledyne','LB_BM','LB_BM_Backup','LB_BM_Precipitation','LB_BM_soil','LB_EC','LB_ST','LB_LFW','AD_Rad','AD_Flux']
...
#Define end points
END_POINT_VK = <Masked>  #End point Veenkampen (site 1, station 1)
END_POINT_LB = <Masked>  #End point Loobos  (site 2, station 2)
END_POINT_AD = <Masked>  #End point Amsterdam  (site 3, station 3)
